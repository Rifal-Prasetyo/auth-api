...
describe('a NewAuthentication entities', () => {
  it('should throw error when payload did not contain needed property', () => {
    ...
    // Action and assert
    expect(() => new NewAuthentication(payload)).toThrow('NEW_AUTHENTICATION.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet type data specification', () => {
    ...
    // Action and assert
    expect(() => new NewAuthentication(payload)).toThrow('NEW_AUTHENTICATION.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
