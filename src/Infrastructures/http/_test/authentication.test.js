...
describe('/authentications endpoint', () => {
  ...
  describe('when POST /authentication', () => {
    ...
    it('should response 400 if login payload wrond data type', async () => {
      // Arrange
      const requestPayload = {
        username: 'dicoding',
        password: true,
  ...
  describe('when PUT /authentication', () => {
    it('should response 200 and get new access token', async () => {
      // Arrange
      const server = await createServer(container);
  ...
  describe('when DELETE /authentication', () => {
    it('should return 400 if refresh token not available in database', async () => {
      // Arrange
      const requestPayload = {
        refreshToken: 'refresh_token',
      };
    ...
    it('should return 400 if refresh token not a string', async () => {
      // Arrange
      const requestPayload = {
        refreshToken: true,
      };
